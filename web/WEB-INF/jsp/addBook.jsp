    ...
    <div class="row clearfix">
        <form action="${pageContext.request.contextPath}/book/addBook" method="post">
            <div class="form-group">
                ...
                <input type="text" name="book_id" class="form-control" id="bk_id" autocomplete="off" required>
            </div>
            <div class="form-group">
                <label for="bk_name">书籍名称: </label>
                <input type="text" name="book_name" class="form-control" id="bk_name" autocomplete="off" required>
            </div>
            <div class="form-group">
                <label for="bk_author">书籍作者: </label>
                <input type="text" name="book_author" class="form-control" id="bk_author" autocomplete="off">
            </div>
            <div class="form-group">
                <label for="bk_publisher">书籍出版商: </label>
                <input type="text" name="book_publisher" class="form-control" id="bk_publisher" autocomplete="off">
            </div>
            <div class="form-group">
                <label for="bk_price">书籍价格: </label>
                <input type="text" name="book_price" class="form-control" id="bk_price" autocomplete="off">
            </div>
            <div class="form-group">
                <label for="bk_number">书籍数目: </label>
                <input type="text" name="book_number" class="form-control" id="bk_number" autocomplete="off" required>
            </div>
            <div class="form-group">
